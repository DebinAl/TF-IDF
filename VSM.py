...
def query_distance():
    print("untuk mencari bobot jarak query")

def document_distance():
    print("untuk mencari bobot jarak document")
    
def dot_product():
    print("mencari dot product")

def cosinus_similarity():
    print("Nilai Cosinus sudut antara vector kata kunci dengan tiap dokumen")

def similarity_rank():
    print("mengurutkan menurut tingkat kesamaan")
